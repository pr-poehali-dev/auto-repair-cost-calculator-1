...
export const UploadBlock = ({ title, description, buttonLabel, accept, onFile, onUpdate, onDownloadTemplate, status, disabled, hasData, children }: {
  ...
  return (
    <div className={`border rounded-lg p-5 transition-colors ${disabled ? "opacity-50 pointer-events-none bg-gray-50" : "bg-white border-border"}`}>
      ...
      <div className="flex flex-wrap gap-2">
        ...
        <button type="button" onClick={() => refLoad.current?.click()}
